...
require('fs').writeFileSync('test_terrain_py.py', pyScript);
const chunkSec = execSync('python test_terrain_py.py');
console.log('Total chunks generated successfully without errors! Output bytes:', chunkSec.length);
