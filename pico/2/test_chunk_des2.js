...
const fs = require('fs');
fs.writeFileSync('temp_chunk_gen2.py', pyScript);
const pktBuf = execSync('python temp_chunk_gen2.py');

des.on('data', d => console.log('CHUNK DESERIALIZED 100% OK! Name:', d.data.name, 'params:', typeof d.data.params));
